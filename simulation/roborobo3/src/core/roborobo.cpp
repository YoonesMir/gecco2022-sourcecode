...
bool gSensoryInputs_lightDetection = false;
...
bool loadProperties( std::string __propertiesFilename )
{
    ...
    if ( gProperties.hasProperty("gMinimumInformation") )
    {
		convertFromString<int>(gMinimumInformation, gProperties.getProperty("gMinimumInformation"), std::dec);

    }
	else
	{
		gMinimumInformation = 0;
	}
    ...
    gProperties.checkAndGetPropertyValue("gSensoryInputs_lightDetection",&gSensoryInputs_lightDetection,false);
    gProperties.checkAndGetPropertyValue("gSensoryInputs_distanceToContact",&gSensoryInputs_distanceToContact,true);
    gProperties.checkAndGetPropertyValue("gSensoryInputs_physicalObjectType",&gSensoryInputs_physicalObjectType,true);
    gProperties.checkAndGetPropertyValue("gSensoryInputs_isOtherAgent",&gSensoryInputs_isOtherAgent,true);
    gProperties.checkAndGetPropertyValue("gSensoryInputs_otherAgentGroup",&gSensoryInputs_otherAgentGroup,true);
    gProperties.checkAndGetPropertyValue("gSensoryInputs_otherAgentOrientation",&gSensoryInputs_otherAgentOrientation,true);
    gProperties.checkAndGetPropertyValue("gSensoryInputs_isWall",&gSensoryInputs_isWall,true);
    gProperties.checkAndGetPropertyValue("gSensoryInputs_groundSensors",&gSensoryInputs_groundSensors,true);
    ...
    gProperties.checkAndGetPropertyValue("gSensoryInputs_distanceToLandmark",&gSensoryInputs_distanceToLandmark,true);
    gProperties.checkAndGetPropertyValue("gSensoryInputs_orientationToLandmark",&gSensoryInputs_orientationToLandmark,true);
    gProperties.checkAndGetPropertyValue("gSensoryInputs_energyLevel",&gSensoryInputs_energyLevel,true);
