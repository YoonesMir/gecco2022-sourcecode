...
Check the projects in prj/ starting with the tutorials projects. Everything you need is there. The code is meant to illustrate how it worksand contains a lot of comments.
...
1. clone a project (go to prj/, use the clone_project.py script). E.g. "python2 clone_project.py exemple MyProjectName"
2. create your own config file (go to config/, copy an existing file). E.g. in the config/ directory, "cp exemple.properties myProjectName.properties"
