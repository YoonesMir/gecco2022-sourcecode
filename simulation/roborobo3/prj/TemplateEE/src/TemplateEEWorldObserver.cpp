...
void TemplateEEWorldObserver::updateMonitoring()
{
...

    {
        ...
        {
            if ( gVerbose )
                std::cout << "[START] Video recording: generation #" << (gWorld->getIterations() / TemplateEESharedData::gEvaluationTime ) << " Iterations: "<<gWorld->getIterations()<<".\n";
            ...
            {
                if ( gVerbose )
                    std::cout << "[STOP]  Video recording: generation #" << (gWorld->getIterations() / TemplateEESharedData::gEvaluationTime ) <<  " Iterations: "<<gWorld->getIterations()<<".\n";
                saveTrajectoryImage();
            }
    }
}
